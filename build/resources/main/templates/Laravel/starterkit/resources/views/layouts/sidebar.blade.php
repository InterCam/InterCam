            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Default')</a></li>
                        <li><a href="#">@lang('translation.Saas')</a></li>
                        <li><a href="#">@lang('translation.Crypto')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#">@lang('translation.Buy_Sell')</a></li>
                        <li><a href="#">@lang('translation.Exchange')</a></li>
                        <li><a href="#">@lang('translation.Lending')</a></li>
                        <li><a href="#">@lang('translation.Orders')</a></li>
                        <li><a href="#">@lang('translation.KYC_Application')</a></li>
                        <li><a href="#">@lang('translation.ICO_Landing')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Projects_Grid')</a></li>
                        <li><a href="#">@lang('translation.Projects_List')</a></li>
                        <li><a href="#">@lang('translation.Project_Overview')</a></li>
                        <li><a href="#">@lang('translation.Create_New')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Task_List')</a></li>
                        <li><a href="#">@lang('translation.Kanban_Board')</a></li>
                        <li><a href="#">@lang('translation.Create_Task')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#">@lang('translation.Image_Cropper')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Elements')</a></li>
                        <li><a href="#">@lang('translation.Forms_Layouts')</a></li>
                        <li><a href="#">@lang('translation.Validation')</a></li>
                        <li><a href="#">@lang('translation.Advanced')</a></li>
                        <li><a href="#">@lang('translation.Editors')</a></li>
                        <li><a href="#">@lang('translation.File_Upload')</a></li>
                        <li><a href="#">@lang('translation.X_editable')</a></li>
                        <li><a href="#">@lang('translation.Form_Repeater')</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Basic_Tables')</a></li>
                        <li><a href="#">@lang('translation.Data_Tables')</a></li>
                        <li><a href="#">@lang('translation.Responsive_Table')</a></li>
                        <li><a href="#">@lang('translation.Editable_Table')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Apexcharts')</a></li>
                        <li><a href="#">@lang('translation.ECharts')</a></li>
                        <li><a href="#">@lang('translation.Chartjs')</a></li>
                        <li><a href="#">@lang('translation.Flot')</a></li>
                        <li><a href="#">@lang('translation.Toast_UI')</a></li>
                        <li><a href="#">@lang('translation.Jquery')</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">@lang('translation.Google_Maps')</a></li>
                        <li><a href="#">@lang('translation.Vector_Maps')</a></li>
                        <li><a href="#">@lang('translation.Leaflet_Maps')</a></li>
                    </ul>
                </li>
